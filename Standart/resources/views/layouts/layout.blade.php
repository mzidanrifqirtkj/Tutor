...
<head>
    ...
    <meta name="keywords"
        content="adminkit, bootstrap, bootstrap 5, admin, dashboard, template, responsive, css, jss, html, theme, front-end, ui kit, web">
    ...
    <link rel="stylesheet" href="{{ url('assets/plugins/select2-bootstrap-theme-master/dist/select2-bootstrap.css') }}">
...
<body>
    <div class="wrapper">
        ...
        <div class="main">
            ...
            <main class="content"
                style="background-image: url('/img/masjidweb.png'); background-size:cover; background-position: 90% 90%;">
                <br><br>
