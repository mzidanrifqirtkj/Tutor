                    ...
                    <div class="card-body">
                        <form action="" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" required
                                    class="form-control  @error('no_kk') is-invalid @enderror" name="no_kk" id="no_kk"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" required class="form-control  @error('no_telp') is-invalid @enderror"
                                    maxlength="15" name="no_telp"  id="no_telp"
                                    value="{{ $pendaftar->no_telp }}" placeholder="+628231234567">
                                @error('no_telp')
                                    <div class="alert alert-danger text-danger">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="form-control">
                                ...
                                <div class="input-group col-xs-12">
                                    <input required accept="image/png, image/gif, image/jpeg, image/jpg" type="file" onchange="previewImage()" name="gambar"
                                        id="gambar" class="file-upload-browse btn btn-inverse-info">
                                </div>
                            </div><br>
                            <div class="form-group mt-4">
                            ...
                            <div class="form-control">
                                ...
                                <div class="input-group col-xs-12">
                                    <input required type="file" onchange="previewImageKK()" accept="image/png, image/gif, image/jpeg, image/jpg" name="gambar_kk"
