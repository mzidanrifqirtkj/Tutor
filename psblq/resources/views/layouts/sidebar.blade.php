<nav id="sidebar" class="sidebar js-sidebar">
    <div class="sidebar-content js-simplebar">
        ...
        <ul class="sidebar-nav">
            ...
            <li class="sidebar-item @if (request()->segment(1) == 'dashboard'  && request()->segment(2) == 'formulir') active
                        @else
                         @endif">
            ...
            <li class="sidebar-item @if (request()->segment(1) == 'dashboard'  && request()->segment(2) == 'download') active
                        @else
                         @endif">
