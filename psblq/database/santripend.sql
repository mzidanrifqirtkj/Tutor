...
CREATE TABLE IF NOT EXISTS `tb_santri` (
  `id_santri` varchar(50) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL DEFAULT 'v',
  ...
  `alamat_ayah` text CHARACTER SET latin1 COLLATE latin1_swedish_ci,
  ...
  `alamat_ibu` text CHARACTER SET latin1 COLLATE latin1_swedish_ci,
  ...
  `alamat_wali` text CHARACTER SET latin1 COLLATE latin1_swedish_ci,
  ...
  `prestasi` text CHARACTER SET latin1 COLLATE latin1_swedish_ci,
  `organisasi` text CHARACTER SET latin1 COLLATE latin1_swedish_ci,
  `jabatan` text CHARACTER SET latin1 COLLATE latin1_swedish_ci,
